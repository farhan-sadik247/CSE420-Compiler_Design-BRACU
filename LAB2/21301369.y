...
func_definition : type_specifier ID LPAREN parameter_list RPAREN 
		{
			symbol_info *func = new symbol_info($2->getname(),"func_def");
...
var_declaration : type_specifier declaration_list SEMICOLON
		 {
			...
			{
				symbol_info *var = table->lookup(var_list[i]);
...
declaration_list : declaration_list COMMA ID
		  {
			...
			symbol_info *var = new symbol_info($3->getname(),"var");
			table->insert(var);
 		  ...
 		  | declaration_list COMMA ID LTHIRD CONST_INT RTHIRD //array after some declaration
 		  {
            ...
            // you may need to store the variable names to insert them in symbol table here or later
            symbol_info *arr = new symbol_info($3->getname(),"array");
 		  ...
 		  |ID
 		  {
            ...
            // you may need to store the variable names to insert them in symbol table here or later
			symbol_info *var = new symbol_info($1->getname(),"var");
			table->insert(var);
 		  ...
 		  | ID LTHIRD CONST_INT RTHIRD //array
 		  {
            ...
            // you may need to store the variable names to insert them in symbol table here or later
            symbol_info *arr = new symbol_info($1->getname(),"array");
